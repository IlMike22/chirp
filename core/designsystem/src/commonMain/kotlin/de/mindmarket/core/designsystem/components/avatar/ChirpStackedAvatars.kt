package de.mindmarket.core.designsystem.components.avatar
...
fun ChirpStackedAvatars(
    ...
    val visibleAvatars = avatars.take(maxVisibleCount)
    val remainingCount = (avatars.size - maxVisibleCount).coerceAtLeast(0)

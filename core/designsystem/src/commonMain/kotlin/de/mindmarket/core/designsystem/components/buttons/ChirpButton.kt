package de.mindmarket.core.designsystem.components.buttons
...
fun ChirpButton(
    ...
    val defaultStroke = BorderStroke(
        width = 1.dp,
        color = MaterialTheme.colorScheme.extended.disabledOutline
    )

    val border = when {
        style == ChirpButtonStyle.PRIMARY && !enabled -> defaultStroke
        style == ChirpButtonStyle.SECONDARY -> defaultStroke
        style == ChirpButtonStyle.DESTRUCTIVE_PRIMARY && !enabled -> defaultStroke

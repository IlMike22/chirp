...
import chirp.feature.auth.presentation.generated.resources.verification_email_resent_successfully
        ...
        when (event) {
            is RegisterSuccessEvent.ResendVerificationEmailSuccess -> {
                snackbarHostState.showSnackbar(
                    message = getString(
                        resource = Res.string.verification_email_resent_successfully
                    )
                )
            }
        }
